...
from core.branding import DISPLAY_NAME, COMPANY_EN, COPYRIGHT
...
class _ModuleDoc(BaseDocTemplate):
    ...
    def _footer(self, canvas, doc):
        ...
        canvas.drawString(15 * mm, 8 * mm, f"{DISPLAY_NAME} — Module Report — Page {doc.page}")
        canvas.drawRightString(A4[0] - 15 * mm, 8 * mm, COPYRIGHT)
        canvas.restoreState()
