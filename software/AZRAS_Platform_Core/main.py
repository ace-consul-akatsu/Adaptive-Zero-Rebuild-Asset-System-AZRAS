...
class AZRASPlatformApp(tk.Tk):
    ...
    def _install_menu(self):
        ...
        help_menu.add_command(label="このソフトについて / About", command=self.show_about)
        menu_bar.add_cascade(label="ヘルプ / Help", menu=help_menu)
    ...
    def show_about(self):
        ...
        body = (
            ...
            f"Developed by\n{COMPANY_EN}\n{COMPANY_JA}\n\n"
            f"{COPYRIGHT}\n{GITHUB}\n\n"
            + (LICENSE_JA if language == "ja" else LICENSE_EN)
        )
        messagebox.showinfo("このソフトについて / About", body, parent=self)
    ...
    def build(self):
        ...
        ttk.Label(
            outer,
            text=f"Developed by {COMPANY_EN} / {COMPANY_JA}",
            font=("Yu Gothic UI", 9),
            foreground="#555555",
            anchor="center",
