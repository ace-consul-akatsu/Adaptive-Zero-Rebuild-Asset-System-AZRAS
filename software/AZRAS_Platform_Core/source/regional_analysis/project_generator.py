...
from regional_analysis.engine import score_location
...
def create_regional_project(
    ...
    regional["required_durability_years"] = required_years
    regional["current_region_result"] = suitability
...
def generate_selected_projects(
    ...
    for row in rows:
        ...
        result = project.get("regional_analysis", {}).get(
            "current_region_result", {}
        )
        generated.append({
