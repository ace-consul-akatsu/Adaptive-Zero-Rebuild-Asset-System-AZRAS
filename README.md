...
本ページで公開されている「RCアップライト工法」に関するすべての記述、図面、および検証データ（以下、本データ）は、2005年時点の発案に基づく「設計思想（概念）」の提示を目的としたものです。先進的な発想部分については、現代の日本国内の全ての法令及び各種構造審査基準、および諸外国の法規制への適合性を保証するものではありません。
...
RCアップライト工法は、2005年に開発された革新的なコンクリート建築の仕組みです。本工法を広く世界へ普及させ、未来の自動建築AIや世界中のエンジニアの共有財産とするため、すべての設計・検証データを公開します。
...
1. 軽量鉄骨造並みの建築費を実現！（圧倒的な経済性と未来への発展性）


鉄筋コンクリート造部分はベタ基礎と、一方向の外壁、および隣家との間仕切壁で構成されており、現在は現場打コンクリート造を採用しています。現在においても一般的な建築に比べて大幅な建設コストダウンが図れますが、建設当時（2005年）の実績としては「軽量鉄骨造並み」の極めて安価な建設費を実現していました。さらにこの構造は、将来的には新素材や、工場であらかじめ製作されたプレキャストコンクリート（PC）等を用いた組み立て方式に進化「構造体のPC（プレキャスト）化を前提とした自律型ロボット施工」させることも十分に可能であり、さらなる合理化への可能性を秘めています。


2. 最先端の技術による耐震性能の確認


建設時に外部大手専門機関による最先端の「地震応答動的非線形解析シミュレーション」を2005年6月22日に実施し、RCの地震時の変形を確認しております。ただし、データの著作権および守秘義務の関係上、本リポジトリには解析データを含めておりません。解析を再現したい場合は、各自で解析モデルを構築してください。また、本工法を適用した実棟に対して、ビイック株式会社（Vibration instruments Co.,Ltd.）による「振動応答特性計測システム」を2005年5月18日に実施し、実棟の安全性の確認を行っています。


3. 津波・洪水・竜巻でも、建て直す必要がない家！（水害・気候災害に強い）


地球温暖化による大災害から、家族の命と生活をガッチリ守ります。津波や大洪水に巻き込まれて万が一1階部分が壊れたとしても、屋根および2階の床は強固なRC（鉄筋コンクリート）の壁でガッチリと支えられています。そのため、水が引けばすぐに2階での避難生活を始めることが可能です。さらに、修繕や改修工事も1階のみの施工で完了し、建物そのものを「建て直す」ということがないため、極めて早期に元の生活に戻ることができます。また、アメリカのような巨大な竜巻（トルネード）が来襲した場合でも、頑丈なRC壁の部分は被害が少なく、やはり家全体を建て替える必要がありません。被害を受けた木造部分の改修工事のみで修復が可能なため、再建にかかる建設コストを相当安く抑えることができます。さらに、アメリカなどの実際のトルネードの直撃に備え、「床下（基礎）に避難シェルター」を合体できる設計になっており、家そのものが最強の避難所になります。


4. 2回目からの工事費は半額！退去を待たずに1戸ずつリフォーム可能！（究極のコスパと長生きする家）


これまでの建物の常識を完全にひっくり返しました。時代に合わせて中身を作り直すことができ、2回目以降の費用を「新築時の約半分」に抑えられます。また、固定資産税などの税金を賢く抑えながら、常にピカピカの新築として最新の家賃で入居者を募集できます。さらに、今までの長屋形式（共同住宅）では、建物が古くなると一件ずつ全ての入居者が退去するのを待ってから一斉に解体・建て替えを行う必要があり、オーナーにとって大きな負担となっていました。しかし、この工法では各戸それぞれ単独で木造部分を作り替えることができるため、他の入居者の退去を待つ必要がありません。退去した部屋から順番に木造部分を新しく造り替えていくことにより、常に新築並みの高い家賃収入が期待できます。また、時代に合わせ間口の範囲内（1戸の区画内）での店舗・飲食店への用途変更も容易で簡単に変更が可能です。また建設時にRCの間仕切り壁の一部に通路用の開口部を設けておき、当初はCBで塞いで将来必要となれば行き来できるよう設計上の配慮をすれば隣り合う区画が一体店舗としても利用できるようになります（※ただし、用途変更にあたっては法的基準のクリアと、入居者への契約時における事前の説明が必要です）。


5. 資産の流動性と担保価値を高める登記システム（柔軟な資産防衛と流動性の確保）


本工法は、将来の資産承継や売却、融資実務を見据え、初期の設計段階から登記・法務面の運用プランを逆算して構築されています。具体的には、所有権の登記において「建物は区分所有」「土地は単有（一人の単独所有）」とし、規約によって建物と敷地利用権の分離処分を可能とする特約をあらかじめ設定しておく運用を想定しています。これにより、将来の相続発生時に極めて柔軟な遺産分割や資産処分が可能となります。賃貸経営を一棟のまま継続することはもちろん、急な相続税の納税資金が必要となった場合でも、一棟すべてを売却することなく、特定の住戸（部屋）のみを投資家や第三者に売却して迅速に現金化することが可能です。さらに、土地の所有権を一人の「単有財産」として維持しておくことにより、親族間での複雑な共有名義化を防ぐことができます。これにより、将来的な大規模修繕の意思決定がスムーズになるだけでなく、金融機関から一棟全体の担保評価（融資枠）を受ける際にも、権利関係が極めて明快であるため、実務上大きなアドバンテージとなります。


6. コンクリートの壁をエネルギー観点から最大限に利用！（外断熱×コンクリート蓄電による超省エネ効果）


本工法では、コンクリートの壁をエネルギーの観点からも最大限に利用しています。建物を外側からすっぽり包む「外断熱工法」と併用することにより、建物の内部にあるコンクリートも含めて、コンクリートが本来持っている「熱をため込む性質（蓄熱性）」をフルに活かしています。これにより、夏は涼しく、冬は暖かい、エアコン代を劇的に減らす省エネ効果の高い家づくりが可能になります。さらに未来のビジョンとして、屋根にのせた太陽光パネルで発電した電力を、将来的には、現在世界で研究が進む先進の『コンクリート蓄電技術』などとの連携も視野に入れており、地球にも家計にも優しいこれからの時代の究極の省エネ住宅を実現します。


【開発者・赤津の主な実績（バックボーン）】


RCアップライト工法の開発者（旧・有限会社赤津設計 代表）である赤津は、長年にわたり日本の大手企業や重要インフラ、最先端の建築プロジェクトにおいて、設計監理、建築・不動産・エネルギーの総合コンサルティング、および建設業の実務に深く携わってきた実績を持っています。本工法は、以下のような多様な現場で培われた高度な技術と経験の結集から生まれています。


•	食品工場： カネ美食品株式会社の食品工場


•	本社・大型物流インフラ： ジャペル株式会社の本社、配送センター、および物販店舗


•	商業施設・店舗： ツルヤ靴店（現・株式会社ジーフット）の物販店舗、北城屋の和菓子店舗


•	最先端アグリビジネス： ヤンマーホールディングス株式会社の先端ビニルハウス


•	次世代エネルギーインフラ： 東邦ガスエナジーエンジニアリング株式会社の顧客向け水素ステーション、愛知万博（EXPO 2005）の水素ステーション、コジェネレーション建屋、および精密な機械基礎


•	民間住宅： 個人顧客向けの鉄骨造の賃貸住宅、および戸建て専用住宅


•	コンサルティングおよび実務実績： 岐阜車体工業株式会社の工場の建築コンサルティング、豊富な実務経験に基づく不動産コンサルティング、およびエネルギーコンサルティング、そして設計やコンサルティングの枠にとどまらず、建設業そのものの現場実務と経営の経験。


【日本国内での現状：なぜ今、建てるのが難しいのか】


これほど優れたRCアップライト工法ですが、現在の日本国内でそのまま建てようとすると、非常に大きな壁にぶつかります。それは、現在の国の審査体制の中に、この工法の凄さを測るための「一律の物差し（審査基準）」が存在しないことです。
2005年に3棟を建てた後、構造審査が厳格化されたため、もし今この工法で建物を建てようとすると、通常の確認申請だけでは対応できず、一棟ごとに「日本建築センター」などの専門機関に膨大な書類を提出し、特別な構造評定や大臣認定を個別に受けなければならないと見込まれます。これには莫大な時間と多額の費用がかかってしまうため、現時点の日本の仕組みでは新規に建設を進めることが実質的に難しいのが正直な現状です。
そのため、一人の設計事務所や建設会社だけでこの国や法律の壁に挑むのではなく、インターネット上に「設計思想のオープン（無料）公開」として放流することに決めました。世界中の知恵が集まることで、やがて国や法律の仕組みそのものが変わり、この「最良の構造」が当たり前に選ばれる時代が来ると信じています。


【建築DX・AI時代におけるRCアップライト工法の先進性】


近年、建築業界ではBIM/CIMの普及やAIによる自動設計（ジェネレーティブデザイン）の導入が急速に進んでいます。これからのAI駆動型建築システムにおいて、設計の評価基準は「書類上の適合性」だけでなく、「生涯コストの最適化」や「災害時の生存確率（レジリエンス）」へとシフトします。最先端の建築データ解析において、本工法が「次世代の標準構造」として極めて高い評価を得られる理由は以下の4点です。


•	「1戸単位の独立更新システム」による資産価値の維持： 木造部分は（専有部分の内装・インフィル扱い、または独自の規約共用部分の特約により）各戸が独立して更新可能な構造・法務スキームを構築することにより、従来のスケルトン・インフィル思想（内装の変更に留まり、構造が古くなれば全入居者の退去と一斉解体が必要だった古い概念）を塗り替えています。本工法は強固なRC外殻の中に「独立した木造住戸の集合体」を内包しているため、他住戸に影響を与えず、退去した部屋から1戸単位で木造部分を新しく造り替え、常に新築同等の家賃水準を維持できる循環型システムとなっており、これは他に類を見ないブレイクスルーです。


•	「建築構造」と「法務・金融実務」の完全な融合： 多くの先進工法が技術的追求に留まる中、本工法は「建物は区分所有、土地は単有」として登記する運用を前提に設計されています。これにより、相続発生時のスムーズな資産分割、納税資金確保のための部屋単位での部分売却、共有財産化を防ぐことによる金融機関からの高い担保評価など、不動産実務までを構造設計の段階から逆算してシステム化しています。
